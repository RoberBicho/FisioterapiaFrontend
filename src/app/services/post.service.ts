...
export class PostService {
  ...
  postPost(post:any) {
    ...
    return this.http.post(_url, post, {headers: headers}).pipe(map( // {title} se pone así por que es el unico parametro que está recibiendo, en este caso son obligatorios más, asi que tendría que enviarle más parámetros
      (resp:any) => {
  ...
  updatePost(post: Post) {
    ...
    let _url = 'http://localhost:4000' + '/post/' + post._id;
